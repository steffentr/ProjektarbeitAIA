...
\pagebreak
\section{Results}
\subsection{Boundary conditions and properties}
The simulations where carried out using ZFS, the simulation tool developed and implemented at the Institute of Aerodynamics of RWTH Aachen University (Zitat Hartmann). The tool is capable of simulating finite-volume flows of compressible fluids.
isotrope Turbulenz
%\begin{figure}
